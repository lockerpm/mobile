...
public class Prefs {
    ...
    public static final String AUTOFILL_HINT_EMAIL = "hint_email";
    ...
    public static String getEmail(SharedPreferences pref) {return pref.getString(AUTOFILL_HINT_EMAIL, "");}
