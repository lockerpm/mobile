...
#ifndef VINCSSFIDO2CLIENTSDK_SWIFT_H
#define VINCSSFIDO2CLIENTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VinCSSFido2ClientSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20VinCSSFido2ClientSDK25Fido2ClientViewController")
@interface Fido2ClientViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC20VinCSSFido2ClientSDK16KeySelectionView")
@interface KeySelectionView : UIView <UIPickerViewDataSource, UIPickerViewDelegate>
...
SWIFT_CLASS("_TtC20VinCSSFido2ClientSDK26KeySelectionViewController")
@interface KeySelectionViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC20VinCSSFido2ClientSDK20WebKitViewController")
...
SWIFT_CLASS("_TtC20VinCSSFido2ClientSDK17WebViewController")
@interface WebViewController : UIViewController <WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
