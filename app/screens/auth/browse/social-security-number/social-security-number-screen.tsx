...
export const SocialSecurityNumberScreen = observer(() => {
  ...
  return (
    <Layout
      ...
      header={(
        <BrowseItemHeader
          header={translate('common.social_security_number')}
          openSort={() => setIsSortOpen(true)}
          openAdd={() => {
            navigation.navigate('socialSecurityNumbers__edit', { mode: 'add' })
          }}
    ...
    >
      ...
      <CipherList
        ...
        searchText={searchText}
        cipherType={CipherType.SocialSecurityNumber}
        sortList={sortList}
        isSelecting={isSelecting}
        setIsSelecting={setIsSelecting}
        selectedItems={selectedItems}
