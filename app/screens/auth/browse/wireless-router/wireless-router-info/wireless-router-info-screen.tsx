...
import { WirelessRouterAction } from "../wireless-router-action"
import { PrimaryParamList } from "../../../../../navigators"

export const WirelessRouterInfoScreen = observer(() => {
  ...
  const route = useRoute<RouteProp<PrimaryParamList, "wirelessRouters__info">>()
  ...
  return (
    ...
    >
      ...
      <View>
        ...
        >
          <BROWSE_ITEMS.wirelessRouter.svgIcon height={55} width={55} />
          <Text
            preset="header"
