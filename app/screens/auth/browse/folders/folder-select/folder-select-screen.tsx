...
export const FolderSelectScreen = observer(() => {
  ...
  const renderItem = (item, index, isCollection: boolean) => (
    ...
    >
      <View style={commonStyles.CENTER_HORIZONTAL_VIEW}>
        ...
        >
          <Text preset="black" text={item.name} numberOfLines={2} />
        ...
        {selectedFolder === item.id && (
          <IoniconsIcon name="checkmark" size={18} color={color.primary} />
        )}
      </View>
    </Button>
  )
  ...
  return (
    ...
    >
      ...
      >
        <View style={commonStyles.CENTER_HORIZONTAL_VIEW}>
          <Text tx={'folder.no_folder'} preset="black" style={{ flex: 1 }} />

          {!selectedFolder && <IoniconsIcon name="checkmark" size={18} color={color.primary} />}
        </View>
      </Button>
      {/* None end */}
