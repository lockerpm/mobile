...
export const EditAlias = (props: Props) => {
  ...
  return (
    <BottomModalContainer>
      <BottomModalHeader
        tx={
          !newAddress ? "private_relay:edit_modal.titel" : "private_relay:edit_modal.confirm_title"
        }
        onClose={onClose}
      />
      ...
      {!!newAddress && (
        <Animated.View entering={FadeInDown} style={styles.container}>
          <Text
            tx={"private_relay:edit_warning"}
            txOptions={{ alias: item.full_address }}
...
const EditView = (item: {
  ...
  return (
    <Animated.View entering={FadeInDown} style={styles.container}>
      ...
      <Text preset="label" size="sm" tx={"private_relay:edit_modal.new"} style={styles.label2} />
