...
export const CipherListEmpty = memo(({ onAdd, cipherTypes, isDeleted }: EmptyCipherListProps) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text preset="bold" size="lg" style={styles.title} tx={content.titleTx} />
      <Text preset="label" tx={content.descTx} size="sm" style={styles.label} />
      {content.buttonTx && <Button tx={content.buttonTx} onPress={onAdd} />}
    </View>
  )
})
CipherListEmpty.displayName = "CipherListEmpty"
