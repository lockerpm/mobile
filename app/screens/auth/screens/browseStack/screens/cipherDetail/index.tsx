...
import { CiphelBaseInfo, CipherIconImage } from "app/components/newCiphers"
...
export const CipherDetailScreen: FC<BrowseStackScreenProps<"cipherDetail">> = observer(
  ({
    navigation,
    route: {
