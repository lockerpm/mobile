...
import { BrowseStackScreenProps } from "app/navigators/navigators.types"
import { AnalyticEvents, logFirebaseEvent } from "app/utils/analytics"
import { useAppLocale } from "app/services/context"
import { useToast } from "app/services/utils"

export const AuthenticatorEditScreen: FC<BrowseStackScreenProps<"authenticatorEdit">> = observer(
  ({ navigation, route }) => {
    ...
    const handleSave = async () => {
      ...
      if (res.kind === "ok") {
        ...
        if (!passwordTotp) {
          ...
          navigation.navigate("passwordsEdit", {
            mode: passwordMode,
          })
        }
      }
