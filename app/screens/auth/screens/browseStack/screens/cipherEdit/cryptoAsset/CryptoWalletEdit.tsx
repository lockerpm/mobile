...
import { SeedPhraseInput } from "app/components/newCiphers"
...
export const CryptoWalletEdit = observer(({ navigation, mode, item, initCollection }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {!!password && (
          <PasswordStrength value={getPasswordStrength(password).score} style={{ marginTop: 8 }} />
        )}
