...
import { ShareWithYouFolder } from "../../shared/ShareWithYouFolder"

export const PendingSharedFolderModalScreen: FC<ShareScreenProps<"pendingSharedFolderModal">> =
  observer(
    ({
      navigation,
      route: {
      ...
      const handleAccept = async () => {
        setIsLoading1(true)
        await acceptShareInvitation(folder.id)
        setIsLoading1(false)
      ...
      const handleReject = async () => {
        setIsLoading2(true)
        await rejectShareInvitation(folder.id)
        setIsLoading2(false)
        onClose()
      }
      return (
        <View style={styles.flex}>
          ...
          <BottomModalContainer>
            <View style={styles.header}>
              <ShareWithYouFolder item={folder} />
            </View>
