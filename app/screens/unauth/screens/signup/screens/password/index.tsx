...
import { openPrivacyPolicy, openTerms } from "@/utils/openLinkInBrowser"
      ...
      >
        ...
        <View style={styles.container}>
          ...
          <TextInput
            ...
            isRequired
            isPassword
            labelTx={"signup:confirm_password"}
            onChangeText={setConfirmPassword}
          />
          <Text size="sm" style={styles.termContainer}>
            {translate("signup:agree_with") + " "}
            <Text size="sm" color={theme.colors.link} tx="signup:terms" onPress={openTerms} />
          ...
          <View style={styles.term}>
            <Text size="sm" preset="label" tx="new_signup:has_account" />
