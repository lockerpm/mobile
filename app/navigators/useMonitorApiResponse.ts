    ...
    if (problem) {
      if (problem.kind === "unauthorized") {
        ...
        if (
          ...
          rootStore.user.setVaultToken("")
          rootStore.cipherStore.setVaultToken("")
          rootStore.collectionStore.setVaultToken("")
          rootStore.enterpriseStore.setVaultToken("")
          rootStore.folderStore.setVaultToken("")
          rootStore.toolStore.setVaultToken("")
