...
import { $inputOuterBase, BaseToggleInputProps, Toggle, ToggleProps } from "./Toggle2"
...
function SwitchInput(props: SwitchInputProps) {
  ...
  const offBackgroundColor = disabled ? colors.disable : colors.block
  ...
  const $themedSwitchInner: StyleProp<ViewStyle> = [
    $toggleInner,
    $switchInner,
