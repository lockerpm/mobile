...
export const imageRegistry = {
  ...
  "phone-incomming": require("assets/images/icons/tools/phone-incomming.png"),
  phone: require("assets/images/icons/tools/phone.png"),
  "phone-list": require("assets/images/icons/tools/phone-list.png"),
