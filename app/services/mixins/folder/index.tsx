...
const defaultData = {
  shareFolder: async (folder: FolderView | CollectionView, emails: string[], role: AccountRoleText, autofillOnly: boolean, groups?: { id: string, name: string }[]) => { return { kind: 'unknown' } },
  shareFolderAddMember: async (collection: CollectionView, emails: string[], role: AccountRoleText, autofillOnly: boolean, groups?: { id: string, name: string }[]) => { return { kind: 'unknown' } },
  shareFolderRemoveMember: async (collection: CollectionView, memberID: string, isGroup?: boolean) => { return { kind: 'unknown' } },
...
export const FolderMixinsProvider = observer((props: { children: boolean | React.ReactChild | React.ReactFragment | React.ReactPortal }) => {
  ...
  // Share Folder
  const shareFolder = async (folder: FolderView, emails: string[], role: AccountRoleText, autofillOnly: boolean, groups?: { id: string, name: string }[]) => {
  ...
  const shareFolderAddMember = async (collection: CollectionView, emails: string[], role: AccountRoleText, autofillOnly: boolean, groups?: { id: string, name: string }[]) => {
  ...
  const shareFolderRemoveMember = async (collection: CollectionView, memberID: string, isGroup?: boolean) => {
    try {
